...
static const char *fonts[] = { "UbuntuMono Nerd Font:size=16:weight=bold:antialias=true:autohint:true" };
...
static Key keys[] = {
    ...
    // Opera
    { MODKEY, XK_o, spawn, SHCMD("opera") },

    // Firefox
    { MODKEY, XK_f, spawn, SHCMD("firefox") },

    // Redshift
    { MODKEY, XK_r, spawn, SHCMD("redshift -O 4692") },
